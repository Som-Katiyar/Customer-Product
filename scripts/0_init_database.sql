...
FROM 'C:\sql\sql-data-analytics-project\datasets\csv-files\customers.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\sql\sql-data-analytics-project\datasets\csv-files\products.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\sql\sql-data-analytics-project\datasets\csv-files\gold.sales.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
